package com.demomvvm.behaviors;
...
public class BottomBarBehavior<V extends View> extends VerticalScrollingBehavior<V> {
    ...
    public BottomBarBehavior(boolean behaviorTranslationEnabled) {
        super();
    ...
    public static <V extends View> BottomBarBehavior<V> from(V view) {
        ...
        return (BottomBarBehavior<V>) behavior;
    }
